...
import com.example.telegrambotshelter.service.catShelter.CallBackCatShelterQueryService;
...
public class CallBackCatShelterQuery implements InputHandlerQuery {
    ...
    public List<PartialBotApiMethod<Message>> handle(long chatId) {
        return callBackCatShelterQueryService.getCallBackCatShelter(chatId);
    }
