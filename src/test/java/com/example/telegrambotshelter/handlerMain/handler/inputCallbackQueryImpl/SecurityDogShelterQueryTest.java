...
@DisplayName("Test Handler Query - SecurityDogShelterQuery")
@ExtendWith(MockitoExtension.class)
class SecurityDogShelterQueryTest {
    @Mock
    private SecurityDogShelterQueryService service;
    @InjectMocks
    private SecurityDogShelterQuery query;
    long chatId = 123L;
    private final BotState botState = BotState.DOG_SHELTER_SECURITY;
    ...
    @DisplayName("JUnit test should return bot state DOG_SHELTER_SECURITY")
    @Test
    void getHandlerName() {
