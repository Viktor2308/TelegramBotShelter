...
class RulesCatShelterQueryTest {
    @Mock
    private RulesCatShelterQueryService service;
    @InjectMocks
    private RulesCatShelterQuery query;
    long chatId = 123L;
    private final BotState botState = BotState.CAT_SHELTER_RULES;
    ...
    @DisplayName("JUnit test should return bot state CAT_SHELTER_RULES")
    @Test
    void getHandlerName() {
