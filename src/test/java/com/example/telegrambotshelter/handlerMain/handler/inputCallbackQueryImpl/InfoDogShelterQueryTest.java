...
@DisplayName("Test Handler Query - InfoDogShelterQuery")
@ExtendWith(MockitoExtension.class)
class InfoDogShelterQueryTest {
    @Mock
    private InfoDogShelterQueryService service;
    @InjectMocks
    private InfoDogShelterQuery query;
    long chatId = 123L;
    ...
    private final BotState botState = BotState.INFO_DOG_SHELTER;

    @DisplayName("JUnit test should return bot state INFO_DOG_SHELTER")
    @Test
    void getHandlerName() {
