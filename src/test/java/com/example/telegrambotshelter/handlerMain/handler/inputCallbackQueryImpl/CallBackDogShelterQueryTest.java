...
import com.example.telegrambotshelter.service.inputCallbackQueryServiceImpl.CallBackDogShelterQueryService;
...
@DisplayName("Test Handler Query - CallBackDogShelterQuery")
@ExtendWith(MockitoExtension.class)
class CallBackDogShelterQueryTest {
    @Mock
    private CallBackDogShelterQueryService service;
    @InjectMocks
    private CallBackDogShelterQuery query;
    long chatId = 123L;
    ...
    private BotState botState = BotState.CALL_BACK_DOG_SHELTER;

    @DisplayName("JUnit test should return bot state CALL_BACK_DOG_SHELTER")
    @Test
    void getHandlerName() {
