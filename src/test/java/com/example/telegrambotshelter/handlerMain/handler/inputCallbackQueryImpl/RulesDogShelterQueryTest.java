...
@DisplayName("Test Handler Query - RulesDogShelterQuery")
@ExtendWith(MockitoExtension.class)
class RulesDogShelterQueryTest {
    @Mock
    private RulesDogShelterQueryService service;
    @InjectMocks
    private RulesDogShelterQuery query;
    long chatId = 123L;
    private final BotState botState = BotState.DOG_SHELTER_RULES;
    ...
    @DisplayName("JUnit test should return bot state DOG_SHELTER_RULES")
    @Test
    void getHandlerName() {
