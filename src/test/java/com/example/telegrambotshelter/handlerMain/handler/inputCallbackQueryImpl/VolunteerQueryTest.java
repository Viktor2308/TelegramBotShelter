...
@DisplayName("Test Handler Query - VolunteerQuery")
@ExtendWith(MockitoExtension.class)
class VolunteerQueryTest {
    @Mock
    private VolunteerQueryService service;
    @InjectMocks
    private VolunteerQuery query;
    long chatId = 123L;
    private final BotState botState = BotState.CALL_VOLUNTEER;
    ...
    @DisplayName("JUnit test should return bot state CALL_VOLUNTEER")
    @Test
    void getHandlerName() {
