...
@DisplayName("Test Handler Query - InfoMenuDogShelterQuery")
@ExtendWith(MockitoExtension.class)
class InfoMenuDogShelterQueryTest {
    @Mock
    private InfoMenuDogShelterQueryService service;
    @InjectMocks
    private InfoMenuDogShelterQuery query;
    long chatId = 123L;
    ...
    private final BotState botState = BotState.INFO_MENU_DOG_SHELTER;

    @DisplayName("JUnit test should return bot state INFO_MENU_DOG_SHELTER")
    @Test
    void getHandlerName() {
