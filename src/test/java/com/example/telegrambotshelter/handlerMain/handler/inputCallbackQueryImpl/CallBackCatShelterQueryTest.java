...
@DisplayName("Test Handler Query - CallBackCatShelterQuery")
@ExtendWith(MockitoExtension.class)
class CallBackCatShelterQueryTest {
    @Mock
    private CallBackCatShelterQueryService service;
    @InjectMocks
    private CallBackCatShelterQuery query;
    long chatId = 123L;
    ...
    private BotState botState = BotState.CALL_BACK_CAT_SHELTER;

    @DisplayName("JUnit test should return bot state CALL_BACK_CAT_SHELTER")
    @Test
    void getHandlerName() {
