...
@DisplayName("Test Handler Query - SecurityCatShelterQuery")
@ExtendWith(MockitoExtension.class)
class SecurityCatShelterQueryTest {
    @Mock
    private SecurityCatShelterQueryService service;
    @InjectMocks
    private SecurityCatShelterQuery query;
    long chatId = 123L;
    private final BotState botState = BotState.CAT_SHELTER_SECURITY;
    ...
    @DisplayName("JUnit test should return bot state CAT_SHELTER_SECURITY")
    @Test
    void getHandlerName() {
