...
@DisplayName("Test Handler Query - MainMenuDogShelterQuery")
@ExtendWith(MockitoExtension.class)
class MainMenuDogShelterQueryTest {
    @Mock
    private MainMenuDogsShelterQueryService service;
    @InjectMocks
    private MainMenuDogShelterQuery query;
    long chatId = 123L;
    private final BotState botState = BotState.SHOW_DOG_SHELTER_MENU;
    ...
    @DisplayName("JUnit test should return bot state SHOW_DOG_SHELTER_MENU")
    @Test
    void getHandlerName() {
