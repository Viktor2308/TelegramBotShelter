...
@DisplayName("Test Handler Query - AddressCatShelterQuery")
@ExtendWith(MockitoExtension.class)
class AddressCatShelterQueryTest {
    @Mock
    private AddressCatShelterQueryService service;
    @InjectMocks
    private AddressCatShelterQuery query;
    long chatId = 123L;
    ...
    @DisplayName("JUnit test should return bot state CAT_SHELTER_ADDRESS")
    @Test
    void getHandlerName() {
